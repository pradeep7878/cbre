...
const Login = () => {
  ...
  const { getTokenAPI, loading,inputRef,setLoading,inputDetails,setInputDetails } = useContext(CommonContext);
              ...
              <div className="card border border-light-subtle rounded-3 shadow-sm">
                <div className="card-body p-3 p-md-4 p-xl-5">
                  <div className="text-center mb-3">
                    ...
                    <img src={require('../images/cbre_logo.png')} alt='cbre-logo' className='cbre-logo' />
                  </div>
                    ...
                    <div className="row gy-2 overflow-hidden">
                      <div className="col-12">
                        <div className="mb-3">
                          ...
                          <input autoFocus ref={inputRef} type="username" className="form-control" id="username" aria-describedby="username" name="username" value={inputDetails.username} onChange={handleChange} />
                        </div>
                        ...
                        <div className="d-grid my-3">
                            {
                              ...
                              <>
                                <button className="btn btn-primary" disabled>
                                    ...
                                    <span className='ms-3' role="status">Loading...</span>
                                </button>
                              </>
                              :
                              <button type="button" className="btn bg-custom mx-auto d-block  w-100"  onClick={(e) => handleSubmit(e)}> 
                                  Login
                              </button>
                            }
                        </div>
